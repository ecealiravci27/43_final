...
public class Board {
    ...
    public SuperField[] setupField(){
        ...
        fields[7] = new ChanceField("?", "Prøv Lykken", 8, true);
        ...
        fields[10] = new SpecialField("Fængsel", "På besøg i fængslet", 11,0, "visitprison");
        fields[11] = new VacantField("FrederiksbergAllé", "", 12, 2800, 7, 200, 1000, 3000, 9000, 12500, 15000, 2000);
        fields[12] = new CoorporationField("Tuborg", "", 13, 3000,  100 );
        ...
        fields[17] = new ChanceField("?", "Prøv Lykken", 18, true);
        ...
        fields[20] = new SpecialField("parkering", "",21,0, "parking");
        fields[21] = new VacantField("Trianglen", "", 22, 4400, 5, 350, 1800, 5000, 14000, 17500, 21000, 3000);
        fields[22] = new ChanceField("?", "Prøv Lykken", 23, true);
        ...
        fields[33] = new ChanceField("?", "Prøv Lykken", 34, true);
        ...
        fields[36] = new ChanceField("?", "Prøv Lykken", 37, true);
